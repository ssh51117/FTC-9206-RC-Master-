...
public class RedLeftAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence toFirstScore = drive.trajectorySequenceBuilder(startPose)
                .lineToSplineHeading(new Pose2d(-39, -9.5, Math.toRadians(230)))
        ...
        Trajectory toLoopCone = drive.trajectoryBuilder(toFirstScore.end())
                ...
                .lineToSplineHeading(new Pose2d(-62.5, -7.5, Math.toRadians(180)))
                .build();
        telemetry.addLine("building trajectory 5/7");
        telemetry.update();
        Trajectory AprilTag1 = drive.trajectoryBuilder(toLoopScore.end())
                .lineToSplineHeading(new Pose2d(-69, -8, Math.toRadians(180)))
                .addTemporalMarker(.4, () -> {
                    wrist.setPosition(.7);
                    spooky.setPosition(0.95);
                    claw.setPosition(.82);
        ...
        Trajectory AprilTag3 = drive.trajectoryBuilder(toLoopScore.end())
                .lineToSplineHeading(new Pose2d(-16, -10, Math.toRadians(180)))
                .addTemporalMarker(.4, () -> {
                    wrist.setPosition(.7);
                    spooky.setPosition(0.95);
                    claw.setPosition(.82);
    ...
    public void grabStack(int level) {
        switch(level) {
            case (1):
                ...
                break;
            case (2):
                wrist.setPosition(.424);
                break;
            case (3):
                wrist.setPosition(.47);
                break;
            case (4):
                wrist.setPosition(.514);
                break;
            case (5):
                wrist.setPosition(.536);
